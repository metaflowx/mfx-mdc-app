      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 px-4 sm:px-8">
        ...
        >
          <div className="w-auto bg-[#0D0D0D] p-10  rounded-[20px]">
            ...
            <div
              data-aos="fade-right"
              className="text-center text-white text-[20px] sm:text-[30px] font-[700] py-4"
            >
              <h2>
                {" "}
            ...
            {/* <div className="block sm:flex items-center justify-between mt-4 mb-8 text-[18px] font-[400]">
              ...
              <div
                data-aos="fade-right"
                className="text-white sm:mt-0 mt-[15px] text-[18px] font-[700]"
              >
        ...
        <div className="flex flex-col text-white justify-center items-center text-left ">
          <h1
            data-aos="fade-right"
            className="w-full  text-[30px] md:text-[60px] font-[700] uppercase"
          >
            Join MDC Coin
          </h1>
          <h2
            data-aos="fade-right"
            className="w-full text-[16px] md:text-[20px] font-[400] uppercase"
          >
            Be a Part of the Decentralized Revolution
          </h2>
          <h3
            data-aos="fade-right"
            className="w-full text-[14px] md:text-[17px] font-[400] py-5"
          >
          ...
          <h2
            data-aos="fade-right"
            className="w-full text-[14px] md:text-[17px] font-[400]"
          >
