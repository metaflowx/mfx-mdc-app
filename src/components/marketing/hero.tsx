...
export default function Hero() {
  ...
  return (
    ...
    className="min-h-screen  flex items-center justify-center sm:mt-0 mt-10 heroBg">
      <div className="contentbg"></div>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 px-8">
        <div className="w-auto bg-[#0D0D0D] p-10  rounded-xl border border-[#1E3A8A]/30">
          {/* Countdown Timer */}
          <div className="  grid grid-cols-2 sm:grid-cols-4 gap-8 mb-8 w-full">
            {[
              { value: "60", label: "DAYS" },
              { value: "45", label: "HOUR" },
              ...
              <div
                key={time.label}
                className="bg-[#1A1A1A] px-6 py-3 rounded-lg text-center min-w-[100px]"
              >
                <div className="text-[30px] md:text-[60px] font-[700] text-white mb-1">
                  {time.value}
                </div>
                <div className="text-[16px] font-[400] text-white">{time.label}</div>
              </div>
            ))}
          </div>
        ...
        <div className="flex flex-col justify-center items-center text-left ">
          <h1 className="w-full text-[40px] md:text-[60px] font-[700] uppercase">Join MDC Coin</h1>
          <h2 className="w-full text-[16px] md:text-[20px] font-[400] uppercase">Be a Part of the Decentralized Revolution</h2>
