    ...
    <main id={id} className="  text-white relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 py-4 md:py-16 relative">
        ...
        <div className="text-left sm:text-center space-y-6 mb-20">
          <h1 data-aos="fade-left" className="text-[25px] md:text-6xl font-bold tracking-wider bg-clip-text">
            Why MDC Coin?
          </h1>
          <h2 data-aos="fade-right" className="text-[20px] font-[400] text-white">
          ...
          {/* CTA Buttons */}
          <div data-aos="fade-up" className="block sm:flex justify-center gap-4 mt-8">
            <ButtonGradient btnName="0x578e...ea4" width="w-full sm:w-[209px]" />

            <ButtonGradient btnName="MDC Whitepaper" width="w-full sm:w-[209px] mt-[3.5rem] sm:mt-0 " />
          </div>
        </div>
      </div>
    </main>
